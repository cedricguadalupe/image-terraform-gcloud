...
This image is built using the following versions:
 - Google Cloud SDK: 435.0.0
 - Terraform: 1.5.0

Latest version : [![latest](https://img.shields.io/badge/terraform--gcloud-1.5.0--435.0.0-green.svg)](https://hub.docker.com/r/cedricguadalupe/terraform-gcloud)
